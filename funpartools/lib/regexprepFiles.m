%% Apply a regexprep substitution to the contents of a groups of
%% files that match a given wildcard, in a given folder
%% The substitution is performed in the file as a whole
