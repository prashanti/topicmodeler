...
void GibbsSamplerAT( double ALPHA, double BETA, int W, int T, int D, int NN, int OUTPUT, int n, int *z, int *d, int *w, int *x, int *wp, int *at, int *ztot, int *atot, int *order, double *probs, mwIndex *irad, mwIndex *jcad, int startcond )
{
