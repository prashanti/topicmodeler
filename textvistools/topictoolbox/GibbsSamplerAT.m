...
%
% |[ WP ] = GibbsSamplerAT( WD,AD,T,N,ALPHA,BETA,SEED,OUTPUT )|
...
% to topic |j|. |T| is the number of topics.   
% 
% |[ WP , AT ] = GibbsSamplerAT( WD,AD,T,N,ALPHA,BETA,SEED,OUTPUT)| runs the
% model with the optional output argument |AT|, a matrix of size |A| x |T|,
% where |AT(i,j)| contains the number of times a word in a document with
% author |i| has been assigned to topic |j|  
%
%% 
% Notes
%
