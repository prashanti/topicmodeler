...
##    # Create a new DBF
##    f = open('C:\\Documents and Settings\\cschmidt\\Desktop\\test.dbf','wb')
##    fieldnames = ['ORDER_ID', 'CUSTMR_ID', 'EMPLOY_ID', 'ORDER_DATE', 'ORDER_AMT']
##    fieldspecs = [('C', 10, 0), ('C', 11, 0), ('C', 11, 0), ('D', 8, 0), ('N', 12, 2)]
##    records = [['10005     ', 'WALNG      ', '555        ', datetime.date(1995, 5, 22), float("173.40")],\
##               ['10004     ', 'BMARK      ', '777        ', datetime.date(1995, 5, 18), float("3194.20")],\
##               ['10029     ', 'SAWYH      ', '777        ', datetime.date(1995, 6, 29), float("97.30")]]
